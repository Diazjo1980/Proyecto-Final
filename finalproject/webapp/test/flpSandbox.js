		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Proyecto Final - Master Fiori Desarrollo SAPUI5",
									"targetURL": "#logaligroupfinalproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligroupfinalproject-display": {
								"semanticObject": "logaligroupfinalproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.finalproject",
									"url": sap.ui.require.toUrl("logaligroup/finalproject")
								}
							}
						}
					}
